...
const formSchema = z
  .object({
    ...
    photo: z
      ...
      .refine((file) => ["image/jpeg", "image/png"].includes(file.type), "Only JPEG and PNG files are accepted"),
...
export default function MembershipJoiningForm() {
  ...
  const typeFromQuery = searchParams.get("plan") // "Life", "Associate", or "Affiliate"

  useEffect(() => {
    if (typeFromQuery === "Life" || typeFromQuery === "Associate" || typeFromQuery === "Affiliate") {
  ...
  const fillWithSeedData = () => {
    // Sample seed data
    const today = new Date()
    const dob = new Date()
    dob.setFullYear(dob.getFullYear() - 35)

    // Create a dummy file for photo
    const dummyPhotoFile = new File([""], "photo.jpg", { type: "image/jpeg" })
    const dummyPdfFile = new File([""], "certificate.pdf", { type: "application/pdf" })

    form.reset({
      firstName: "John",
      lastName: "Doe",
      address: "123 Medical Center",
      streetAddress: "Orthopaedic Avenue",
      ...
      phone: "9876543210",
      dob: dob,
      pgDegree: "MS Orthopaedics",
      pgCollege: "Medical College Bangalore",
      pgYear: "2015",
      mbbsCollege: "Government Medical College",
      mbbsYear: "2010",
      photo: dummyPhotoFile,
      medicalCouncilCert: dummyPdfFile,
      pgCertificate: dummyPdfFile,
      proposerName: "Dr. Rajesh Kumar",
      proposerKoaNumber: "KOA12345",
      seconderName: "Dr. Priya Sharma",
      seconderKoaNumber: "KOA67890",
      email: "john.doe@example.com",
      password: "Password123",
      confirmPassword: "Password123",
      upiTransactionId: "UPI123456789",
      upiTransactionDate: today,
    })

    // Set previews
    setPhotoPreview("/placeholder.svg?height=80&width=80")
    setMedicalCertPreview("dummy")
    setPgCertPreview("dummy")
  }
  ...
  return (
    <PageLayout title="Membership Joining Form">
      <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-6">
        <div className="mb-8">
          <h1 className="text-2xl font-bold mb-4">{plan} Membership Application Form</h1>

          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
            <h2 className="font-bold mb-2">Important Instructions</h2>
            <ol className="list-decimal pl-5 space-y-2 text-sm">
              <li>
                A photo in JPEG or PNG format that is under 2 MB is required. No selfies will be accepted; the photo
                must be a headshot. If necessary, use Image Compressor to make the photo smaller.
              </li>
              <li>
                All degree certificates must be in PDF format and weigh no more than 5MB each. If necessary, use PDF
                Compressor to make the pdf smaller.
              </li>
              <li>You must use your UPI ID to complete the payment in order to complete the registration procedure.</li>
              <li>
                After the online application has been submitted, your membership no and user id will be activated after
                ratification in the upcoming annual general body meeting
              </li>
            </ol>
            <p className="mt-3 text-sm">
              Please call this number at{" "}
              <a href="tel:+919880765855" className="text-blue-600">
                +91 9880765855
              </a>{" "}
          ...
          {/* <div className="flex gap-2 mb-4">
            <Button variant="outline" onClick={fillWithSeedData}>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Accepted file type: JPG, PNG for Photo & PDF for Certificates. Max. file size: 2 MB for Photo & 5 MB per
                Certificate
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Medical Council Certificate (Required)</FormLabel>
                      <FormControl>
                        <div className="flex flex-col gap-2">
                          <Input
                            type="file"
                            ...
                            className="hidden"
                          />
                          <Button type="button" variant="outline" onClick={() => medicalCertRef.current?.click()}>
                            Choose File
                          </Button>
                          {medicalCertPreview ? (
                            <div className="mt-2 flex items-center gap-2">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>MS / D Ortho / DNB Certificate (Required)</FormLabel>
                      <FormControl>
                        <div className="flex flex-col gap-2">
                          <Input
                            type="file"
                            ...
                            className="hidden"
                          />
                          <Button type="button" variant="outline" onClick={() => pgCertRef.current?.click()}>
                            Choose File
                          </Button>
                          {pgCertPreview ? (
                            <div className="mt-2 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col items-center p-4 border rounded-lg">
                  <div className="bg-gray-100 p-4 rounded mb-4">
                    {/* Mock UPI QR Code */}
                    <div className="bg-white flex items-center justify-center border border-dashed border-gray-300">
                      <div className="text-center">
                        <div className="text-xs mb-1">
                          <Image
                            src="../../../assets/upiImage.png"
                            width={250}
                            height={250}
                            alt="QR Code"
                          />
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    To successfully complete the form, please make a payment of ₹ 3000/- by scanning the above QR code
                    with your UPI app. Please also enter the transaction ID/number and transaction date in the fields
                    below.
                  </p>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    const currentValues = form.getValues()
                    setFormData(currentValues)
                    router.push("/membership/download")
                  }}
