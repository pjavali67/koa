...
import { BarChart, Users, Newspaper, Calendar } from "lucide-react"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="grid gap-2">
            <div className="rounded-md bg-secondary p-3 hover:bg-secondary/80 cursor-pointer">
            ...
            <div className="rounded-md bg-secondary p-3 hover:bg-secondary/80 cursor-pointer">
              <p className="font-medium">Post Blog</p>
            </div>
            <div className="rounded-md bg-secondary p-3 hover:bg-secondary/80 cursor-pointer">
